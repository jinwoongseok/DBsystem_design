...
<legend><strong font-size="14">질문내용</strong></legend>
<table>
...
<center>
         ...
         <tr>
            ...
            <form action="상담제출.asp" method="post">
              <tr>
			<td><textarea  style='width:500; height:100;' name="qq" placeholder = "상담내용을 입력해주세요" rows="5" cols="5"></textarea></td>
		</tr>
